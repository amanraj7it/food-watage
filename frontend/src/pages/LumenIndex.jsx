...
function NavItem({ number, label, delay }) {
  return (
    <div
...
function CentralNodes() {
  return (
    <div className="absolute inset-0 pointer-events-none hidden md:block">
      ...
      {/* 6 Connector lines in elbow pairs */}
...
export default function LumenIndex() {
      ...
      <div className="relative z-10 w-full h-full">
        ...
        <nav className="absolute top-0 left-0 w-full flex items-center px-5 md:px-[35px] py-5 md:py-[27px]">
          ...
          >
            ...
            <span className="bg-[#AFDDFF] rounded-[3px] px-[5px] py-[2px] text-black text-[13px] leading-[15.6px]">
              PRIME_MEMBER
            </span>
          </div>
        ...
        {/* Full-bleed Grid lines + plus intersections */}
        <GridLines />

        {/* Central nodes & connectors */}
        <CentralNodes />
          ...
          >
            ...
            <div className="relative p-[20px]">
              ...
              <p className="relative font-manrope text-white text-[13px] leading-[18px] mb-[18px]">
                Maps the complexity of modern finance with a partner that brings
                clarity and organic growth to your portfolio.
              </p>
